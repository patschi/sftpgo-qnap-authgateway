...
| `SFTPGO_API_URL`            | `http://sftpgo:8080`                                       | API URL for sftpgo instance for virtual folder sync                           |
...
| `SFTPGO_API_CHECK_CERT`     | `true`                                                     | Verify sftpgo TLS cert; set to `false` to disable verification                |
